...
function fncAddProduct() {
	// Form 유효성 검증
	var prod_name=document.detailForm.prodName.value;
	var prod_detail=document.detailForm.prodDetail.value;
	var manu_date=document.detailForm.manuDate.value;
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="prodDetail"
					class="ct_input_g" style="width: 500px; height: 50px" /></td>
			</tr>
